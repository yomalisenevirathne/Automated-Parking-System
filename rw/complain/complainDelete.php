...
<head>
    ...
    <link rel="stylesheet" href="./CSS/deleteComplain.css">
...
<body>
    <form action="deleteComplain-php.php" method="post">
        ...
        <input type="text" id="complain" name="dcomplain" value="<?php echo $complain; ?>" readonly>

        <button style="background-color: red; padding: 10px 20px; color: white; border: none; border-radius: 5px;">Delete</button>
    </form>
